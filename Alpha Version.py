...
def Main():
    ...
    while True:
        ...
        if start != "start":
            ...
            time.sleep(2.5)
            retry = input("Enter anything to go back to retry or type 'exit' to quit: ")
            if retry.lower() == "exit":
                exit()
            else:
    ...
    if Choice1 == "1":
        ...
        print()
        time.sleep(2.5)
        print("Susan:'I'm starting to get worried, they're both been gone for a min'")
        print()
        time.sleep(2.5)
    while True:
        time.sleep(2.5)
    ...
    if VersionA == "1":
        print()
        print("Susan:'Let's go look for them'")
        print()
    while True:
        time.sleep(2.5)
        print("'Type 1: Go'")
    ...
    if VersionA2 == "1":
        ...
        print()
        time.sleep(2.5)
        print(f"'{name} heard a noise of metal clanging from a distance'")
        print()
    ...
    # checkpoint                
    if 'Choice2' in locals() and Choice2 == "1":
        print()
        ...
        if Restart == "":
            Main()
    elif 'Choice2' in locals() and Choice2 == "2":
    ...
    if 'Choice5' in locals() and Choice5 == "1":
    ...
    elif 'Choice5' in locals() and Choice5 == "2":
        print(f"{name}:'Derek, where are you!'")
        print()
        time.sleep(2.5)
